/* js-yaml 3.6.1 https://github.com/nodeca/js-yaml */ ! function(e) {
    ...
    return function e(t, n, i) {
        ...
        3: [function(e, t, n) {
            ...
            function j(e, t, n, i, r, o) {
                ...
                if (u && (s = e.duplicates.indexOf(n), c = -1 !== s), (null !== e.tag && "?" !== e.tag || c || 2 !== e.indent && t > 0) && (r = !1), c && e.usedDuplicates[s]) e.dump = "*ref_" + s;
                else {
            ...
            function S(e, t, n) {
                ...
                if (null !== e && "object" == typeof e)
                    ...
                    for (r = 0, o = e.length; o > r; r += 1) S(e[r], t, n);
                else
                    for (i = Object.keys(e), r = 0, o = i.length; o > r; r += 1) S(e[i[r]], t, n)
            }
        ...
        5: [function(e, t, n) {
            ...
            function g(e, t, n, i) {
                ...
                if (n > t) {
                    if (s = e.input.slice(t, n), i)
                        for (r = 0, o = s.length; o > r; r += 1) a = s.charCodeAt(r), 9 === a || a >= 32 && 1114111 >= a || h(e, "expected valid JSON character");
            ...
            function x(e, t, n, i, r, o) {
                ...
                if (r = String(r), null === t && (t = {}), "tag:yaml.org,2002:merge" === i)
                    if (Array.isArray(o))
                        for (a = 0, s = o.length; s > a; a += 1) y(e, t, o[a], n);
                    else y(e, t, o, n);
